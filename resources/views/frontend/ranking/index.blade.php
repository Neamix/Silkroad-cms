                                ...
                                @if(config('siteSettings.char_ranking', true))
                                    <div class="btn-group p-2" role="group"
                                        ...
                                        <a href="{{ route('ranking.char') }}"
                                           type="button"
                                           class="btn btn-outline-dark btn-toggle-custom @if($mode === config('ranking.search-charname')) active @endif">
                                ...
                                @if(config('siteSettings.guild_ranking', true))
                                    <div class="btn-group p-2" role="group"
                                        ...
                                        <a href="{{ route('ranking.guild') }}"
                                           type="button"
                                           class="btn btn-outline-dark btn-toggle-custom @if($mode === config('ranking.search-guild')) active @endif">
                                ...
                                @if(config('siteSettings.job_ranking', true))
                                    <div class="btn-group p-2" role="group"
                                        ...
                                        <a href="{{ route('ranking.job') }}"
                                           type="button"
                                           class="btn btn-outline-dark btn-toggle-custom  @if($mode === config('ranking.search-job')) active @endif">
                                ...
                                @if(config('siteSettings.trader_ranking', true))
                                    <div class="btn-group p-2" role="group"
                                        ...
                                        <a href="{{ route('ranking.job.trader') }}"
                                           type="button"
                                           class="btn btn-outline-dark btn-toggle-custom @if($mode === config('ranking.search-trader')) active @endif">
                                ...
                                @if(config('siteSettings.hunter_ranking', true))
                                    <div class="btn-group p-2" role="group"
                                        ...
                                        <a href="{{ route('ranking.job.hunter') }}"
                                           type="button"
                                           class="btn btn-outline-dark btn-toggle-custom @if($mode === config('ranking.search-hunter')) active @endif">
                                ...
                                @if(config('siteSettings.thief_ranking', true))
                                    <div class="btn-group p-2" role="group"
                                        ...
                                        <a href="{{ route('ranking.job.thief') }}"
                                           type="button"
                                           class="btn btn-outline-dark btn-toggle-custom @if($mode === config('ranking.search-thief')) active @endif">
                                ...
                                @if(config('siteSettings.unique_ranking', true))
                                    <div class="btn-group p-2" role="group"
                                        ...
                                        <a href="{{ route('ranking.unique') }}"
                                           type="button"
                                           class="btn btn-outline-dark btn-toggle-custom @if($mode === config('ranking.search-unique')) active @endif">
                                ...
                                @if(config('siteSettings.free_pvp_ranking', true))
                                    <div class="btn-group p-2" role="group"
                                        ...
                                        <a href="{{ route('ranking.pvp.free') }}"
                                           type="button"
                                           class="btn btn-outline-dark btn-toggle-custom @if($mode === config('ranking.search-free-pvp')) active @endif">
                                ...
                                @if(config('siteSettings.job_pvp_ranking', true))
                                    <div class="btn-group p-2" role="group"
                                        ...
                                        <a href="{{ route('ranking.pvp.job') }}"
                                           type="button"
                                           class="btn btn-outline-dark btn-toggle-custom @if($mode === config('ranking.search-job-pvp')) active @endif">
